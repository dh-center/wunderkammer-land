                        ...
                        <div className="navbar_logo_block">
                            <svg
                                ...
                                <g>
                                    ...
                                    c-8.7-4.6-17.1-4.5-25.6,0.6C76.3,223.7,47.7,174.2,19,124.5z"></path>
                                    <path
                                        fill="#ffffff"
                                    ...
                                    c37.4,88,10.9,193.1-69.1,252.3c-78.4,58.1-186.1,55.5-261.7-7.6C-0.9,310.2-15.8,209,15.1,134.4z"></path>
                                </g>
                            </svg>
                        </div>
                ...
                <div className="menu_container menu-top_container">
                    <ul className="menu-top flex column content--start items--start">
                        ...
                        <a
                            ...
                            <div
                                className={`menu-bullet menu-bullet_cabinet ${
                                    isMenuCabinetOpen && isNavbarOpen && 'cabinet--open'
                                }`}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                    <circle
                                        r="50%"
                            ...
                            <li className={`menu_cabinet ${isMenuCabinetOpen && 'cabinet--open'}`}>
                                Кабинет
                            </li>
                        </a>

                        <ul
                            className={`submenu submenu-cabinet hidden ${
                                isMenuCabinetOpen && 'transition-active'
                            }`}>
                            <li>
