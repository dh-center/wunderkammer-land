                ...
                <div className="section_logo">
                    <Link to="/">
                        <svg
                            ...
                            c-22.1,38.3-44.1,76.4-66.2,114.6c-8.7-4.6-17.1-4.5-25.6,0.6C76.3,223.7,47.7,174.2,19,124.5z"></path>
                                <path
                                    style={{ fill: '#0000FF' }}
                            ...
                            c28.6-49.5,57.3-99.2,86.1-149.1c37.4,88,10.9,193.1-69.1,252.3c-78.4,58.1-186.1,55.5-261.7-7.6C-0.9,310.2-15.8,209,15.1,134.4z"></path>
                            </g>
                        </svg>
                    </Link>
                </div>
            ...
            <div className="main_section right flex column content--start items--start">
                ...
                <article className="article_container">
                    ...
                    <p className="article_content">
                        В образах ярких, выдающихся исторических личностей необыкновенно
                        притягательны их человеческие, житейские привычки и пристрастия, которые
                        многократно приближают к нам людей прошедших эпох, сокращая временную и
                        социальную дистанцию. В этом смысле Петр Великий оставил потомкам
                        исключительное нематериальное наследие, получившее воплощение в конкретных
                        материальных памятниках. Мы же, со своей стороны, стремимся через них
                        постичь личность первого российского императора.
                    </p>
