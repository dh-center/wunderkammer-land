...
const Home2 = () => {
    return (
        <>
            <main className="layout_index desktop-only">
                <div className="i_back_container flex column content--start items--center">
                    <div className="i_title">
                        <transition name="slide-fade" mode="out-in">
                            <span className="i_title" v-if="iTriggers.iKeyHover" key="1">
                                Цифровая коллекция первого русского императора
                            </span>
                            <span className="i_title" v-else-if="iTriggers.iAnchorHover" key="2">
                                Открой для&nbsp;себя кабинет чудес Петра&nbsp;Великого
                            </span>
                            <span className="i_title" v-else-if="iTriggers.iDividersHover" key="3">
                                Интерактивная карта петровской эпохи
                            </span>
                            <span className="i_title" v-else="" key="4">
                                Wunderkammer
                            </span>
                        </transition>
                    </div>
                    <div className="i_portrait_container">
                        <div className="i_portrait"></div>
                    </div>
                </div>

                <div className="i_front_container">
                    ...
                    <transition name="fade">
                        <div className="i_item i_key" v-if="iTriggers.iKeyHover">
                            <a href="collection.html">
                                <img src="images\gif\anim_key-2.gif?ver=1661251347" alt="" />
                            </a>
                        </div>
                    </transition>

                    <transition name="fade">
                        <div className="i_item i_anchor" v-if="iTriggers.iAnchorHover">
                            <a href="cabinet.html">
                                <img src="images\gif\anim_anchor-2.gif?ver=1661251347" alt="" />
                            </a>
                        </div>
                    </transition>

                    <transition name="slide-sec4">
                        <div className="i_item i_dividers" v-if="iTriggers.iDividersHover">
                            <a href="map.html">
                                <img src="images\gif\anim_dividers-2.gif?ver=1661251347" alt="" />
                            </a>
                        </div>
                    </transition>
                </div>
