        ...
        <>
            <main className="layout_index0 desktop-only">
                <div className="i0_back_container flex column content--start items--center">
                    <div className="i0_title">
                        <transition name="slide-fade" mode="out-in">
                            <span
                                className="i0_title"
                                v-if="iMove.isMoveEnd && iStart.showTitle && iTriggers.iKeyHover"
                                key="1">
                                Цифровая коллекция первого русского императора
                            </span>
                            <span
                                className="i0_title"
                                v-else-if="iMove.isMoveEnd && iStart.showTitle && iTriggers.iAnchorHover"
                                key="2">
                                Открой для&nbsp;себя кабинет чудес Петра&nbsp;Великого
                            </span>
                            <span
                                className="i0_title"
                                v-else-if="iMove.isMoveEnd && iStart.showTitle && iTriggers.iDividersHover"
                                key="3">
                                Интерактивная карта петровской эпохи
                            </span>
                            <span className="i0_title" v-else-if="iStart.showTitle" key="4">
                                Wunderkammer
                            </span>
                        </transition>
                    </div>
                    <transition name="slide-fade">
                        <div className="i0_portrait_container" v-if="iStart.showPetr">
                ...
                <div className="i0_front_container">
                    <div className="i0_line"></div>

                    <transition name="slide-fade">
                        <div v-if="iStart.showPoints">
                            <div className="i0_point i0_point-1">
                                <Link to="/collection">
                            ...
                            <div className="i0_point i0_point-2">
                                <Link to="/cabinet">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                        <circle r="50%" cx="50%" cy="50%"></circle>
                                    </svg>
                            ...
                            <transition name="slide-sec4">
                                <div
                                    className="i0_point i0_point-3"
                                    v-if="!iTriggers.iDividersHover">
                                    <Link to="/map">
                                        <svg
                    ...
                    <transition name="fade">
                        <div
                            className="i0_item i0_key"
                            v-if="iMove.isMoveEnd && iTriggers.iKeyHover">
                            <Link to="/collection">
                                <img src="images\gif\anim_key.gif?ver=1661251335" alt="" />
                            </Link>
                        </div>
                    </transition>
                    ...
                    <transition name="fade">
                        <div
                            className="i0_item i0_anchor"
                            v-if="iMove.isMoveEnd && iTriggers.iAnchorHover">
                            <Link to="/cabinet">
                                <img src="images\gif\anim_anchor.gif?ver=1661251335" alt="" />
                            </Link>
                        </div>
                    </transition>
                    ...
                    <transition name="slide-sec4">
                        <div
                            className="i0_item i0_dividers"
                            v-if="iMove.isMoveEnd && iTriggers.iDividersHover">
                            <Link to="/map">
                                <img src="images\gif\anim_dividers.gif?ver=1661251335" alt="" />
                            </Link>
                        </div>
                    </transition>
                </div>
            ...
            <main className="layout_index mobile-only">
                <div className="i_back_container flex column content--start items--center">
                    <div className="i_title" v-cloak="">
                        <transition name="slide-fade">
                            <div v-if="iStart.showTitle">Wunderkammer</div>
                        </transition>
                    </div>
                    <transition name="slide-fade">
                        <div className="i_portrait_container" v-if="iStart.showPetrMob">
                ...
                <transition name="slide-fade">
                    <div className="i_front_container" v-if="iStart.showPointsMob">
                        ...
                        <div className="i_item i_key">
                            ...
                            c12-0.3,18.6-10.4,18.5-19.1C1045,140.3,1036.6,132,1025.9,132.1z"></path>
                                </svg>
                            </Link>
                        </div>
                        ...
                        <div className="i_item i_anchor">
                            ...
                            c-0.1,8.6,6.9,15.7,15.4,15.6C99.8,483.9,106.6,477.1,106.7,468.7z"></path>
                        ...
                        <div className="i_item i_dividers">
                            <Link to="/map">
                                ...
                                c-0.6,1.4-1,2.8-1,4.3C77.3,378.5,77.2,382.1,77.2,385.8z"></path>
                                ...
                                C322.3,361.8,319.2,359.1,319.1,355.6z"></path>
                                        <path
                                ...
                                C297,364.5,294.1,361.4,294.2,358.1z"></path>
                                ...
                                C719.3,362.7,722.1,365.4,722.2,368.9z"></path>
                                ...
                                C344.1,349.2,346.8,346.6,350.5,346.7z"></path>
                                ...
                                C188.9,582.5,191.7,585.2,191.6,588.7z"></path>
                                ...
                                c-0.1,13.1,10.9,24.3,24,24.4c13.2,0.1,24.2-10.7,24.4-24C271.9,40.5,261.1,29.5,247.7,29.4z"></path>
                                        <path
