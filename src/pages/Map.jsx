        ...
        <main className="layout_main flex row mobile--column content--space-between mobile-content--start items--start">
                    ...
                    <div className="dividers_top_container flex row content--start items--start">
                        <div className="dividers_top_left_container flex row content--end items--end">
                            <div className="dividers_container">
                                ...
                                c2.2-3.7,4.3-7.6,6.5-11.3c0.8-1.4,2.2-2.8,1.4-4.7C158.3,406.4,153.4,403.4,147.9,400.6z"></path>
                                    <path
                                ...
                                c0.1-6-3.8-10.9-9-12.6c-1.9-0.6-4-1.8-6-1c-2.9,1.1-5.9,2-8.1,4.6c-5,6.3-4.7,11.6-0.1,17.4C321.2,81.4,322.6,82.6,323.4,83.4z"></path>
                                </svg>
                            </div>
                        </div>
            ...
            <div className="main_section right flex column content--space-between items--start">
                ...
                <div className="section_content">
                    ...
                    мест он посетил, городов и фабрик основал, побед одержал, а поражений преодолел.
                    Находясь в постоянном необузданном физическом и ментальном движении, он с каждым
                    годом раскручивал всё сильнее и сильнее маятник истории, изменяя не только
                    Россию, но весь окружающий мир. Увидеть это становится возможно с помощью
                    интерактивной карты петровской эпохи, которая наглядно покажет как
