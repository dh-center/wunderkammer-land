        ...
        <main className="layout_main flex row mobile--column content--space-between mobile-content--start items--start">
            <div className="main_section left desktop-only">
                ...
                <div className="key_wrapper flex column content--space-between items--center">
                    ...
                    <div className="key_container">
                        ...
                        c-6.5-0.3-11.1,4.9-12.2,11.5C93,31.7,97.7,36.9,106.5,39.2z"></path>
                        </svg>
                    </div>
                </div>
            </div>
            ...
            <div className="main_section right flex column content--space-between items--start">
                ...
                <div className="section_content">
                    Ассамблея петровских музеев России объединяет свыше 110 культурных институций,
                    каждая из которых бережно хранит память о Петре Великом. С помощью платформы
                    «Сорока» мы хотим создать цифровую коллекцию первого русского императора:
                    музейные предметы, памятники, города, легенды, утраченное и любое другое
