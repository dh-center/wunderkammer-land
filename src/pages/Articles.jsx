            ...
            <div className="main_section left desktop-only">
                ...
                <div className="section_image_wrapper">
                    <img
                        src={imageUrl}
                        alt=""
                        className={`${imageUrl ? 'transition-active' : 'hidden'}`}
                    />
                </div>
            </div>
                ...
                <div className="section_content articles_container">
                    <div className="articles_block">
                        <Link
                            ...
                            <div className="articles_title">
                                Невозможно было не узнать его: всякого поражало врожденное ему
                                величие. <br />
                    ...
                    <div className="articles_block">
                        <Link
                            ...
                            onMouseLeave={() => setImageUrl('')}>
                            <div className="articles_title">
                                Петровская иконография в западно-европейских изданиях XVIII–XIX
                                веков
                            </div>
                    ...
                    <div className="articles_block">
                        <Link
                            ...
                            onMouseLeave={() => setImageUrl('')}>
                            <div className="articles_title">
                                Приказал подать cамый большой бокал, какой только могли найти. Три
                                этюда о кубке
                            </div>
                    ...
                    <div className="articles_block">
                        <Link
                            ...
                            <div className="articles_title">
                                ...
                                Петровский Петергоф в произведениях Императорского фарфорового
                                завода первой четверти XIX века
                            </div>
