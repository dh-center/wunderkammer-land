        ...
        <main className="layout_main flex row mobile--column content--space-between mobile-content--start items--start">
            <div className="main_section left desktop-only">
                ...
                <div className="anchor_wrapper flex column content--space-between items--center">
                    ...
                    c-0.1,33.8,27.6,61.7,61.5,61.9c33.9,0.2,62.1-27.9,62-61.9c-0.1-33.9-27.9-61.7-61.7-61.7C331.9,29.4,304,57.2,303.9,91z"></path>
                        </svg>
                    </div>
                </div>
            </div>
            <div className="main_section right flex column content--space-between items--start">
                ...
                <div className="section_content">
                    Петровская эпоха многообразна и уникальна. Рассказать и показать о всем
                    своеобразии этого временя должен петровский Кабинет – место погружения в
                    петровскую эпоху через статьи, медиа и другой разнообразный контент.
                </div>
