...
<main class="layout_main flex row mobile--column content--space-between mobile-content--start items--start" :class="{'navbar--open':isNavbarOpen}">
    ...
    <div class="main_section left desktop-only">
        ...
        <div class="dividers_wrapper flex column content--space-between items--center">
            <div class="dividers_top_container flex row content--start items--start">
                <div class="dividers_top_left_container flex row content--end items--end">
                    <div class="dividers_container">
                        <svg version="1.1" id="Слой_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 633.5 659.8" style="enable-background:new 0 0 633.5 659.8;" xml:space="preserve">
                            <path d="M175.4,426.3c-0.7,1.1-1.7,2.4-2.5,3.8c-3.8,7.1-7.3,14.3-11.5,21.2c-3.4,5.6-6.3,11.4-9.7,17c-3.8,6.2-7.1,12.7-10.9,19
                                ...
                                c2.2-3.7,4.3-7.6,6.5-11.3c0.8-1.4,2.2-2.8,1.4-4.7C158.3,406.4,153.4,403.4,147.9,400.6z"/>
                                                        <path d="M321.2,102.6C309.8,99,302.4,91.5,298.7,80c-0.3-1.7-0.9-3.8-1.2-6c-0.5-4.7,0.6-9.3,2.3-13.5c1.9-5,4.6-9.9,9-13.2
                ...
                <div class="dividers_top_right_container">
                </div>

            </div>
            <div class="dividers_bottom_container flex row content--start items--start">
                <div class="dividers_bottom_left_container">
                </div>
                <div class="dividers_bottom_right_container">
                </div>
            </div>
    ...
    <div class="main_section right flex column content--space-between items--start">
        <div class="section_title_container flex row content--space-between items--start">
            ...
            <div class="anchor_container_mobile dividers mobile-only">
                <svg version="1.1" id="Слой_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     viewBox="0 0 633.5 659.8" style="enable-background:new 0 0 633.5 659.8;" xml:space="preserve">
                            <path d="M175.4,426.3c-0.7,1.1-1.7,2.4-2.5,3.8c-3.8,7.1-7.3,14.3-11.5,21.2c-3.4,5.6-6.3,11.4-9.7,17c-3.8,6.2-7.1,12.7-10.9,19
                                c-2.1,3.6-4,7.4-6.1,11c-2.8,4.7-5.2,9.5-8,14.2c-2,3.4-3.7,7.1-5.8,10.6c-4.6,7.7-8.4,15.9-13.4,23.5c-2.4,3.6-3.9,7.7-6.1,11.4
        ...
        <div class="section_content">
            Читая, слушая, рассуждая о жизни Петра Великого каждый раз удивляешься сколько мест он посетил, городов и фабрик основал, побед одержал, а поражений преодолел. Находясь в постоянном необузданном физическом и ментальном движении, он с каждым годом раскручивал всё сильнее и сильнее маятник истории, изменяя не только Россию, но весь окружающий мир. Увидеть это становится возможно с помощью интерактивной карты петровской эпохи, которая наглядно покажет как «преображался» и «жил» мир.
        </div>
