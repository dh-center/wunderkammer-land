<?php
$page_title = 'Статьи | Wunderkammer';
include 'header.php';
?>
...
<main class="layout_main flex row mobile--column content--space-between mobile-content--start items--start" :class="{'navbar--open':isNavbarOpen}">
    ...
    <div class="main_section left desktop-only">
        <div class="section_logo">
            <a href="index2.php">
                <svg version="1.1" id="Слой_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <path fill="#0000FF" d="M64.9,135.7c-4.7-2.1-8.7-2.1-12.8,0.4c-14.4-25-28.6-49.6-42.8-74C23.9,27.8,62.3-1.2,108.5,0
                        ...
                        C86.9,97.6,76,116.4,64.9,135.7z"/>
                                        <path fill="#0000FF"  d="M140.5,138.5c-3,7.9-2.1,12.8,2.5,16.4c4.1,3.2,9.7,3.3,14,0.3c4.9-3.4,5.9-8.6,3-16.7c14.1-24.4,28.2-48.8,42.5-73.5
        ...
        <div class="section_image_wrapper">
            <transition name="slide-articles">
            <!--<img src="images/petr_articles.jpg" alt="" />-->
    ...
    <div class="main_section right flex column content--start items--start">
        <h1 class="section_title blue">
            Статьи
        </h1>
        <div class="section_content articles_container">
            <div class="articles_block">
                <a href="single-article.php" @mouseover="imageUrl = 'images/articles_petr.jpg'" @mouseleave="imageUrl = ''">
                    ...
                    <div class="articles_author">
                        Автор: Оксана Каяндер
                    </div>
                </a>
            </div>
            <div class="articles_block">
                <a href="single-article.php" @mouseover="imageUrl = 'images/articles_ikona.jpg'" @mouseleave="imageUrl = ''">
                    <div class="articles_title">
                        Петровская иконография в западно-европейских изданиях XVIII–XIX веков
                    </div>
                    <div class="articles_author">
                        Автор: Марина Трубановская
                    </div>
                </a>
            </div>
            <div class="articles_block">
                <a href="single-article.php" @mouseover="imageUrl = 'images/articles_grafin.jpg'" @mouseleave="imageUrl = ''">
                    <div class="articles_title">
                        Приказал подать cамый большой бокал, какой только могли найти. Три этюда о кубке
                    </div>
                    <div class="articles_author">
                        Автор: Марина Брюханова
                    </div>
                </a>
            </div>
            <div class="articles_block">
                <a href="single-article.php" @mouseover="imageUrl = 'images/articles_farfor.jpg'" @mouseleave="imageUrl = ''">
                    <div class="articles_title">
